...
_GCP_RESOURCE_NORMALIZERS: dict[str, ResourceNormalizer] = {
    ...
    "google_compute_firewall_policy": normalize_compute_firewall_policy,
    "google_compute_firewall_policy_association": normalize_compute_firewall_policy_association,
    "google_compute_firewall_policy_rule": normalize_compute_firewall_policy_rule,
