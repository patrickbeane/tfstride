...
class GcpResourceMetadata:
    ...
    HIERARCHY_PARENT = OptionalStringMetadataField("hierarchy_parent")
    HIERARCHY_UNKNOWN_FIELDS = StringListMetadataField("hierarchy_unknown_fields")
    ...
    FIREWALL_POLICY_UNKNOWN_FIELDS = StringListMetadataField("firewall_policy_unknown_fields")
