...
AZURE_LIMITATIONS = (
    ...
    "for supported data-plane resources, and public virtual-machine exposure through public-IP, NIC, subnet, "
    "and NSG relationships; broader Azure RBAC hierarchy, MySQL, Private Endpoint DNS correctness, "
    "load-balancer, and platform-service modeling are not implemented yet.",
)
