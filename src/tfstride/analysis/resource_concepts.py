...
WORKLOAD_RESOURCE_TYPES = _DEFAULT_RESOURCE_CAPABILITY_REGISTRY.resource_types(ResourceCapability.WORKLOAD)
...
PUBLIC_COMPUTE_RESOURCE_TYPES = _DEFAULT_RESOURCE_CAPABILITY_REGISTRY.resource_types(ResourceCapability.PUBLIC_COMPUTE)
DATA_STORE_RESOURCE_TYPES = _DEFAULT_RESOURCE_CAPABILITY_REGISTRY.resource_types(ResourceCapability.DATA_STORE)
PUBLIC_EDGE_RESOURCE_TYPES = _DEFAULT_RESOURCE_CAPABILITY_REGISTRY.resource_types(ResourceCapability.PUBLIC_EDGE)
IDENTITY_ROLE_RESOURCE_TYPES = _DEFAULT_RESOURCE_CAPABILITY_REGISTRY.resource_types(ResourceCapability.IDENTITY_ROLE)
IAM_POLICY_RESOURCE_TYPES = _DEFAULT_RESOURCE_CAPABILITY_REGISTRY.resource_types(ResourceCapability.IAM_POLICY)
...
SUBNET_RESOURCE_TYPES = _DEFAULT_RESOURCE_CAPABILITY_REGISTRY.resource_types(ResourceCapability.SUBNET)
DATABASE_RESOURCE_TYPES = _DEFAULT_RESOURCE_CAPABILITY_REGISTRY.resource_types(ResourceCapability.DATABASE)
OBJECT_STORAGE_RESOURCE_TYPES = _DEFAULT_RESOURCE_CAPABILITY_REGISTRY.resource_types(ResourceCapability.OBJECT_STORAGE)
SECRET_STORE_RESOURCE_TYPES = _DEFAULT_RESOURCE_CAPABILITY_REGISTRY.resource_types(ResourceCapability.SECRET_STORE)
...
OBJECT_STORAGE_PUBLIC_ACCESS_CONTROL_RESOURCE_TYPES = _DEFAULT_RESOURCE_CAPABILITY_REGISTRY.resource_types(
    ResourceCapability.OBJECT_STORAGE_PUBLIC_ACCESS_CONTROL
)
KEY_MANAGEMENT_RESOURCE_TYPES = _DEFAULT_RESOURCE_CAPABILITY_REGISTRY.resource_types(ResourceCapability.KEY_MANAGEMENT)
...
PROVIDER_MANAGED_EGRESS_WITHOUT_VPC_RESOURCE_TYPES = _DEFAULT_RESOURCE_CAPABILITY_REGISTRY.resource_types(
...
def has_provider_managed_egress_without_vpc(resource: NormalizedResource) -> bool:
    return (
        _has_capability(resource, ResourceCapability.PROVIDER_MANAGED_EGRESS_WITHOUT_VPC) and not resource.vpc_enabled
    )
