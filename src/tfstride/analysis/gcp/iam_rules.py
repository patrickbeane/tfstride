...
from tfstride.analysis.gcp.iam_service_accounts import (
    ...
    high_risk_service_account_role_risk as _high_risk_service_account_role_risk,
    service_account_iam_target as _service_account_iam_target,
)
...
class GcpIamRuleDetectors(GcpSensitiveResourceIamDetectors, GcpServiceAccountIamDetectors):
