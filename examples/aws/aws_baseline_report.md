...
- Evidence:
  - target vpc: address=aws_vpc.main; type=aws_vpc; identifier=vpc-00000002; cidr_block=10.10.0.0/16
  - flow log coverage: target_vpc_id=vpc-00000002; resolved_vpc_flow_log_count=0; aws_flow_log resources are not modeled
...
- Evidence:
  - target workload: address=aws_lambda_function.processor; type=aws_lambda_function; vpc_id=vpc-00000002; subnet_ids=[subnet-safe-private-app-001]; security_group_ids=[sg-safe-app-001]
  ...
  - vpc endpoint coverage: vpc_id=vpc-00000002; service=s3; expected_endpoint_type=gateway_or_interface; vpc_endpoint_coverage=missing
