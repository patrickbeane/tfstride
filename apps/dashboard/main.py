...
class UploadSizeLimitMiddleware:
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        try:
            ...
            response = _upload_limit_response(scope, receive)
    ...
    async def analyze_api(
        ...
        try:
            ...
            return JSONResponse(
                ...
                content={
                    "kind": "tfstride-error",
                    "message": _public_dashboard_error_message(exc),
                },
            )
...
def _upload_limit_response(scope: Scope, receive: Receive) -> HTMLResponse | JSONResponse:
